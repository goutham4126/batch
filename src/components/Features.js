            ...
            <div className="px-5 lg:py-10 mx-auto flex flex-wrap">
                ...
                <div className="flex flex-col mb-5 gap-4 items-start">
                    <div className="flex gap-3">
                        <div className="w-8 h-8 inline-flex items-center justify-center rounded-full bg-orange-200 text-orange-600">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4" viewBox="0 0 24 24">
                                 <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
                            </svg>
                        </div>
                        <div className="flex-grow">
                            <h2 className="text-gray-900 text-lg font-semibold">Budgeting Intervals</h2>
                        </div>
                    </div>
                    <div className="flex-grow">
